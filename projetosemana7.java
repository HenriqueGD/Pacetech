...
public class projetosemana7 {
    ...
    Scanner leitor = new Scanner(System.in);
        ...
        while(continuar == 'S' || continuar == 's'){
            ...
            System.out.println("  ---------------------------------------");
            System.out.println("** Tecle uma opção do MENU:");
            ...
            if(resposta == 1){
                ...
                System.out.println(celsius + "ºC em fahrenheit é: "
                            + fahrenheit + "ºF");
                System.out.println("• Quer realizar uma outra conversão? "
                        + "Responda Sim ou Não");
                ...
                if(resposta == 2){
                    ...
                    if(resposta == 3){
                        ...
                        System.out.println("R$" + dinheiro + " em dólares são US$: " + dolar);
                        System.out.println("• Quer realizar uma outra conversão?"
                                + " Responda Sim ou Não");
                        continuar = leitor.next().charAt(0);
                        ...
                        if(resposta == 4){
                            System.out.println("• Informe a cotação do dólar hoje:");
                            reais = leitor.nextFloat();
                            System.out.println("• Digite a sua quantia em dólares:");
                            dinheiro = leitor.nextFloat();
